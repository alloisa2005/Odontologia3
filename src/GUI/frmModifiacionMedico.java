 ...
 * @author User
 */
public class frmModifiacionMedico extends javax.swing.JDialog {
    ...
    public frmModifiacionMedico(javax.swing.JDialog parent, boolean modal, Medico med, JDialog padre) {
        super(parent, modal);
        this.medico = med;
        ...
        dteFchIngreso.setDate(med.getFch_ingreso());
        txtDireccion.setText(med.getDireccion());
        txtTelefono.setText(med.getTelefono());
        txtCelular.setText(med.getCelular()); 
        if(med.getFoto() != null){
            lblFoto.setIcon(med.getFotoImage());
            fotoPerfil = med.getFoto();
        }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(971, 755));
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if(sigo.equals("S") && txtDireccion.getText().equals("")){
            sigo = "N";
            JOptionPane.showMessageDialog(this, "Dirección de médico requerida", "Validación de datos", JOptionPane.ERROR_MESSAGE);
        ...
        if(sigo == "S"){
            ...
            Conexion.getInstance().Actualizar(med);
            
            JOptionPane.showMessageDialog(this, "Médico modificado exitosamente", "Modificación de datos", JOptionPane.INFORMATION_MESSAGE);            
