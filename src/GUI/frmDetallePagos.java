 ...
 * @author User
 */
public class frmDetallePagos extends javax.swing.JDialog {
    ...
    public frmDetallePagos(javax.swing.JDialog parent, boolean modal, Paciente paciente) {
        super(parent, modal);
        initComponents();                
    ...
    public void CargarTablaConsultas(Paciente paciente){
        ...
        if(it.hasNext()){
            while (it.hasNext()) {
                ...
                Double montoDeuda = conAux.getMonto() - montoPagado;                
                fila[5] = montoDeuda.toString();                                
    ...
    private void initComponents() {
        ...
        tblConsultas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nro. Consulta", "Fecha", "Título", "Monto Consulta", "Monto Pagado", "Monto Adeudado"
            }
        ) {
